...
import Earning from '../../Earning/Earning.jsx';
...
<div class="main-wrapper">
    ...
    <section gsap="group" class="sec_hero">
        <div class="container container-large">
          <div class="hero-wrapper">
            <h1  reveal="frombottom" class="heading-style-h1">Turn Your Unused Internet Into Crypto Treasure! Earn <span class="gradient_text">BLU Tokens</span> for Every GB Shared!</h1>
            <div reveal="frombottom" class="hero_btn-wrap wrap">
              <div class="hero-tag">
            ...
            <div reveal="frombottom" class="hero_desc-wrap">
          ...
          <div reveal="frombottom"  class="hero-img-wrap"><img src={headermainImage} loading="lazy" alt="Hero Main Image"></img></div>
      ...
      <section  id="about-us" class="sec_about" gsap="group">
        <div class="container container-large">
          <div class="about-grid">
            <div reveal="frombottom" class="grid_item">
            ...
            <div class="grid_item">
              <div class="about_img-wrap" reveal="grow"><img src={aboutImg}   alt="About us Image" class="about-img"></img></div>
            </div>
          </div>
      ...
      <section id="earning" class="sec_earning"  >
        <div class="container container-large">
          <div  class="earning-content" gsap="group">
            ...
            <div reveal="frombottom"  class="earning_desc-wrap">
            ...
            <div reveal="frombottom" class="earning-grid">
            ...
            <div reveal="frombottom"  class="earning_verified">
    ...
    <section class="step_wrapper" gsap="group">
    <Steps />
    </section>
    <div class="overflow-x-clip">
      ...
      <section id="technology" class="sec_technology" gsap="group">
        <div class="container container-large">
          <div class="company-shadow"></div>
          <div reveal="frombottom"  class="section-title-wrap">
            <div class="section-tag"><img src={technologyTag} loading="lazy" alt="Section Tag"></img></div>
            <h2 class="heading-style-h2">Powered By</h2>
          </div>
          <div reveal="frombottom"  class="technology-grid">
            <div id="w-node-_2879fd43-dba0-21c0-6654-8b55fcd60964-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={metamasklogoImg} loading="lazy" alt="Digital China" class="metamask-logo"></img></div>
            </div>
            <div class="grid_item">
              <div class="technology-item"><img src={walletconnectLogo} loading="lazy" alt="Exor" class="walletconnect-logo"></img></div>
            </div>
            <div id="w-node-b4a0d4d4-6f5a-ba17-82d3-b442660424c6-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={trustwalletLogo} loading="lazy" alt="" class="trustwallet-logo"></img></div>
            </div>
            <div id="w-node-_64660303-6335-8b3e-0966-bd737710bb1d-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={awsLogo} loading="lazy" alt="" class="aws-logo"></img></div>
            </div>
            <div id="w-node-_150bb63c-0d10-59d5-b52e-561c34c3a1c0-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={googleLogo} loading="lazy" alt="" class="google-logo"></img></div>
            </div>
            <div id="w-node-_5e365f05-98e4-4a53-11b2-0c173f076ac5-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={openAi} loading="lazy" alt="" class="openai-logo"></img></div>
            </div>
            <div id="w-node-_64119e4c-4805-4277-f15d-2887628c83e8-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={githubLogo} loading="lazy" alt="" class="github-logo"></img></div>
            </div>
            <div id="w-node-_4ea3801c-0a45-6549-9382-4a486949471d-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={telegramLogo} loading="lazy" alt="" class="telegram-logo"></img></div>
            </div>
            <div id="w-node-b1575f2e-d19a-6d3f-9297-fc4f6f1093df-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={solanaLogo} loading="lazy" alt="" class="solana-logo"></img></div>
            </div>
            <div id="w-node-_7844ca93-b11a-fbf9-133c-a9700d81b72d-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={coinmarketLogo} loading="lazy" alt="" class="coinmarketcap-logo"></img></div>
            </div>
            <div id="w-node-_597e4e78-637f-c520-de77-1b4a2bd0b6cf-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={coingeckoLogo} loading="lazy" alt="" class="coingecko-logo"></img></div>
            </div>
            <div id="w-node-_7230fc21-721d-fab4-7f53-9c8e1c96d614-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={mysqlLogo} loading="lazy" alt="" class="mysql-logo"></img></div>
            </div>
            <div id="w-node-_9c88372c-e0b8-2063-7b30-2f371fe149ee-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={reactLogo} loading="lazy" alt="" class="react-logo"></img></div>
            </div>
            <div id="w-node-_6b540df8-cf39-65be-31a7-4ada6ef8d88c-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={figmaLogo} loading="lazy" alt="" class="figma-logo"></img></div>
            </div>
            <div id="w-node-d7720803-3425-7725-9f90-a9b218cb49ff-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={googleanalyticsLogo} loading="lazy" alt="" class="googleanalytics-logo"></img></div>
            </div>
            <div id="w-node-_0e70843a-50ab-6ef9-499d-7afb2ca3b6e6-ab90d4da" class="grid_item">
              <div class="technology-item"><img src={ledgerLogo} loading="lazy" alt="" class="ledger-logo"></img></div>
            </div>
          </div>
        </div>
        <div class="section_divider">
      ...
      <section id="share" class="sec_share" gsap="group">
        <div class="container container-large">
          <div reveal="frombottom"  class="section-title-wrap">
            {/* <div class="section-tag"><img src={shareImg} loading="lazy" alt="Section Tag"></img></div> */}
            <h2 class="heading-style-h2">Spread the Word</h2>
          </div>
          <div class="share_shadow"></div>
          <div class="share_shadow _2"></div>
          <div class="share_grid">
            <div reveal="frombottom" class="grid_item">
              <div   class="share-content">
                <p class="text-size-regular">Unite your circle into BlueNode, where collective endeavors lead to unparalleled rewards. Embrace a new era of passive cryptocurrency income.</p>
                <div class="share_img-wrap is_formob" reveal="grow">
                  <div class="share_img-holder" >
                    <div class="share-img-wrap"><img src={bIcon} loading="lazy" alt="" class="share-logo"></img></div><img src={shareGif} loading="lazy"  alt="" class="share-gif"></img>
                  </div>
                </div>
                <div class="share-platform-wrap">
                  <a href="#" class="share_social-media w-inline-block"><img src={twitterImg} loading="lazy" alt=""></img></a>
                  <a href="#" class="share_social-media w-inline-block"><img src={telegramsocialmediaLogo} loading="lazy" alt=""></img></a>
                  <a href="#" class="share_social-media w-inline-block"><img src={facebookLogo} loading="lazy" alt=""></img></a>
                  <a href="#" class="share_social-media w-inline-block"><img src={roboLogo} loading="lazy" alt=""></img></a>
                  <a href="#" class="share_social-media w-inline-block"><img src={whatsappLogo} loading="lazy" alt=""></img></a>
                </div>
                <a href="#" class="secoundry-button w-inline-block">
                  <div class="button_inner-wrap">
                    <div>Share Now</div>
            ...
            <div  class="grid_item is_forweb">
              <div class="share_img-wrap" reveal="grow">
                <div class="share-img-wrap"><img src={bIcon} loading="lazy" alt="" class="share-logo"></img></div><img src={shareGif} loading="lazy"  alt="" class="share-gif"></img>
              </div>
            </div>
          </div>
      ...
      <section id="blu" class="sec_tokenomics" gsap="group">
        <div class="container container-large">
          <div class="tokenomics_shadow"></div>
          <div reveal="frombottom"  class="section-title-wrap">
            <div class="section-tag"><img src={bluImg} loading="lazy" alt=""></img></div>
            <h2 class="heading-style-h2">Tokenomics</h2>
          </div>
          <div class="tokenomics-wrap" reveal="frombottom">
            <div class="tokenomics-content"><img src={tokenomics1Img} loading="lazy"   alt="" class="tokenomics-img for-web"></img> <img src={mobiletokenomicsLogo} loading="lazy"  alt="" class="tokenomics-img fot-mob"></img></div>
          </div>
        </div>
        <div class="section_divider">
          <div class="sec_left-divider"><img src={dividerleftLine} loading="lazy" alt="" class="divider_line"></img></div><img src={rotateGif} loading="lazy" alt="" class="rotate-gif"></img>
        ...
        <Roadmap />
      <section id="faq" class="sec_faq" gsap="group">
        <div class="container container-large">
          <div class="faq_shadow"></div>
          <div class="faq_shadow _2"></div>
          <div class="faq_shadow _3"></div>
          <div reveal="frombottom"  class="section-title-wrap">
            <div class="section-tag"><img src={faqTag} loading="lazy" alt=""></img></div>
