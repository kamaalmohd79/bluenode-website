...
<div className="main-wrapper">
    ...
    <section gsap="group" className="sec_hero">
        <div className="container container-large">
          ...
          <div reveal="frombottom"  className="hero-img-wrap"><img src={headermainImage}  alt="Hero Main Image"></img></div>
        ...
        <div className="container container-large">
          <div className="about-grid">
            ...
            <div className="grid_item">
              <div className="about_img-wrap" reveal="grow"><img src={aboutImg}   alt="About us Image" className="about-img"></img></div>
            </div>
          </div>
            ...
            <div reveal="frombottom" className="grid_item">
              <div   className="share-content">
                ...
                <div className="share-platform-wrap">
                  <a href="#" className="share_social-media w-inline-block"><img src={twitterImg}  alt=""></img></a>
                  <a href="#" className="share_social-media w-inline-block"><img src={telegramsocialmediaLogo}  alt=""></img></a>
                  <a href="#" className="share_social-media w-inline-block"><img src={facebookLogo}  alt=""></img></a>
                  <a href="#" className="share_social-media w-inline-block"><img src={roboLogo}  alt=""></img></a>
                  <a href="#" className="share_social-media w-inline-block"><img src={whatsappLogo}  alt=""></img></a>
                </div>
                <a href="#" className="secoundry-button w-inline-block">
                  <div className="button_inner-wrap">
                    <div>Share Now</div>
