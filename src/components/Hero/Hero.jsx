            ...
            <section className="sec_hero">
                <div className="container container-large">
                    <div className="hero-wrapper">
                        <h1 data-w-id="00e57a4b-fffa-ad9f-94ce-489ff395655f" className="heading-style-h1">Turn Your Unused Internet Into Crypto Treasure! Earn <span className="gradient_text">BLU Tokens</span> for Every GB Shared!</h1>
                        <div data-w-id="47b978bd-a9e1-d4d2-8349-d4cbbb53a7c4" className="hero_btn-wrap wrap">
                        ...
                        <div data-w-id="97a9aa83-e26a-91bd-2f2e-716c341aea24" className="hero_desc-wrap">
                        ...
                        <div data-w-id="d6fab5df-d2c0-5ef1-8063-20a63d6d46aa" className="hero_btn-wrap">
                            <Link to="/buy-page" className="secoundry-button w-inline-block">
                                <div className="button_inner-wrap secoundry">
                                    <div>Join Presale</div>
                                </div>
                            </Link>
                            <Link to="#" className="secoundry-button w-inline-block">
                                <div className="button_inner-wrap secoundry">
